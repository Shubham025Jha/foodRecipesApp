package com.upstox.android.foody.ui.fragments.overview
...
import com.upstox.android.foody.bindingadapters.RecipesRowBinding
import com.upstox.android.foody.databinding.FragmentOverViewBinding
...
class OverViewFragment : Fragment(){
    ...
    override fun onCreateView(
        ...
        //parsing HTML text to normal text by using parseHTML function of RecipesRowBinding
        RecipesRowBinding.parseHtml(binding.summaryTextView,myBundle.summary)

        updateColors(myBundle.vegetarian,binding.veganTextView,binding.veganImageView)
